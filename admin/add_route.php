...
if(isset($_POST['submit']))
{
    ...
    $stop_number=mysql_escape_string($_POST['stop_number']);
    $Station_ID=mysql_escape_string($_POST['Station_ID']);
    $Arrival_time=mysql_escape_string($_POST['Arrival_time']);
    $Departure_time=mysql_escape_string($_POST['Departure_time']);
